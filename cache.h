#include <inttypes.h>
// You have to define a struct for evict for this to work
#include "lru.h"
...
struct cache_keyval{
	...
	node_t node;// Must be defined for this to work
};
...
struct cache_obj{
	...
	struct cache_keyval * keyvals;
	
	struct evict * eviction; // Must be defined for this to work
};
